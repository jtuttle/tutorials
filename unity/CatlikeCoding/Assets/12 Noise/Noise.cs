...
public static class Noise {
    ...
    private const int _hashMask = 255;
    ...
    public static float Value1D(Vector3 point, float frequency) {
        ...
        return Mathf.Lerp(h0, h1, t) * (1f / _hashMask);
    }
    ...
    public static float Perlin2D(Vector3 point, float frequency) {
        ...
        int h0 = _hash[ix0];
        int h1 = _hash[ix1];
        Vector2 g00 = gradients2D[_hash[h0 + iy0] & gradientsMask2D];
        Vector2 g10 = gradients2D[_hash[h1 + iy0] & gradientsMask2D];
        Vector2 g01 = gradients2D[_hash[h0 + iy1] & gradientsMask2D];
        Vector2 g11 = gradients2D[_hash[h1 + iy1] & gradientsMask2D];
    ...
    public static float Perlin3D(Vector3 point, float frequency) {
        ...
        int h01 = _hash[h0 + iy1];
        int h11 = _hash[h1 + iy1];
        Vector3 g000 = gradients3D[_hash[h00 + iz0] & gradientsMask3D];
        Vector3 g100 = gradients3D[_hash[h10 + iz0] & gradientsMask3D];
        Vector3 g010 = gradients3D[_hash[h01 + iz0] & gradientsMask3D];
        Vector3 g110 = gradients3D[_hash[h11 + iz0] & gradientsMask3D];
        Vector3 g001 = gradients3D[_hash[h00 + iz1] & gradientsMask3D];
        Vector3 g101 = gradients3D[_hash[h10 + iz1] & gradientsMask3D];
        Vector3 g011 = gradients3D[_hash[h01 + iz1] & gradientsMask3D];
        Vector3 g111 = gradients3D[_hash[h11 + iz1] & gradientsMask3D];
